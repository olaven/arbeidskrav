...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        client.displayMenu(); 
        */ 
        MeterArchive a = new MeterArchive(); 
        a.testing(); 
    }
    ...
    public void demo() {
        ...
        if (archive.move("TID123", "H126")) {
            ...
            if (movedMeter != null)
                System.out.println(movedMeter.toString());
            else
                System.out.println("This was not supposed to happen..");//should not run 
        }
        sleep(2000);
        ...
        if (meterAltered)
            System.out.println(archive.fetch("TID123").toString());
        else
            System.out.println("This was not supposed tot happen..");
        sleep(2000);
        ...
        sleep(2000);
        if (!archive.remove("TID132"))
            System.out.println("This did not work.. Oh, the same typo!");
        sleep(1000);
        if (archive.remove("TID123"))
            System.out.println("Corrected the ID. Now it works!");
        sleep(3000);
